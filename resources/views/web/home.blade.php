            ...
            <div class="d-flex align-items-center js-fullheight">
                <div class="author-image text img d-flex">
                    <section class="home-slider js-fullheight owl-carousel">
                        <div class="slider-item js-fullheight" style="background-image: url(assets/web/images/author.jpg);">
                        </div>
                        <div class="slider-item js-fullheight" style="background-image:url(assets/web/images/author-2.jpg);">
                        </div>
                    </section>
                </div>
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="assets/web/images/image_1.jpg" class="insta-img image-popup"
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="assets/web/images/image_2.jpg" class="insta-img image-popup"
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="assets/web/images/image_3.jpg" class="insta-img image-popup"
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="assets/web/images/image_4.jpg" class="insta-img image-popup"
                        style="background-image: url(assets/web/images/image_4.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="assets/web/images/image_5.jpg" class="insta-img image-popup"
                        style="background-image: url(assets/web/images/image_5.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
